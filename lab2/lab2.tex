...
\begin{figure}[h!]
  \begin{center}
    \subfloat[Original]{\includegraphics[scale=0.15]{img/harrypotter_1}\label{fig2}}
    \hspace{10mm}
    \subfloat[Aplicacação de Harris]{\includegraphics[scale=0.15]{img/harrypotter_1_t7500000000_harris.eps}\label{fig2Diff}}
